...
cartographer_proto::mapping::SubmapsOptions2D CreateSubmapsOptions2D(
  ...
  cartographer_proto::mapping::SubmapsOptions2D options;
  ...
  *options.mutable_range_data_inserter_options() =
  ...
  const cartographer_proto::mapping::GridOptions2D_GridType& grid_type =
      options.grid_options_2d().grid_type();
  const cartographer_proto::mapping::
      RangeDataInserterOptions_RangeDataInserterType& range_data_inserter_type =
          options.range_data_inserter_options().range_data_inserter_type();
  if (grid_type ==
          cartographer_proto::mapping::GridOptions2D::PROBABILITY_GRID &&
  ...
  if (grid_type == cartographer_proto::mapping::GridOptions2D::TSDF &&
      range_data_inserter_type ==
          cartographer_proto::mapping::RangeDataInserterOptions::
              TSDF_INSERTER_2D) {
    valid_range_data_inserter_grid_combination = true;
...
Submap2D::Submap2D(const cartographer_proto::mapping::Submap2D& proto,
                   ValueConversionTables* conversion_tables)
  ...
  if (proto.has_grid()) {
    if (proto.grid().has_probability_grid_2d()) {
      ...
      LOG(FATAL) << "cartographer_proto::mapping::Submap2D has grid with "
                    "unknown type.";
    }
  }
...
cartographer_proto::mapping::Submap Submap2D::ToProto(
...
ActiveSubmaps2D::CreateRangeDataInserter() {
  switch (options_.range_data_inserter_options().range_data_inserter_type()) {
    case cartographer_proto::mapping::RangeDataInserterOptions::
        PROBABILITY_GRID_INSERTER_2D:
...
std::unique_ptr<GridInterface> ActiveSubmaps2D::CreateGrid(
  ...
  switch (options_.grid_options_2d().grid_type()) {
    case cartographer_proto::mapping::GridOptions2D::PROBABILITY_GRID:
      return absl::make_unique<ProbabilityGrid>(
          ...
          &conversion_tables_);
    case cartographer_proto::mapping::GridOptions2D::TSDF:
